        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 t-mb-50 mb-lg-0">
                    <div class="accordion zol-accordion" id="accordionExample">
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
                                            biggest risk is a missed option
                                        </span>
                                        <span class="zol-accordion__card-btn-icon">
                            ...
                            <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                <div class="card-body zol-accordion__card-body">
                        ...
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
                        ...
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
                ...
                <div class="col-lg-6">
                    <div class="accordion zol-accordion" id="accordionExample2">
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseOne2" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
                        ...
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseTwo2" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
                        ...
                        <div class="card t-mb-10 zol-accordion__card">
                            <div class="card-header zol-accordion__card-header">
                                <h4 class="mb-0 mt-0">
                                    <a class="d-flex justify-content-between w-100 text-left btn zol-accordion__card-btn text-capitalize" data-toggle="collapse" data-target="#collapseThree2" aria-expanded="true" href="#">
                                        <span class="zol-accordion__card-btn-text">
