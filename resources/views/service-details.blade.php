                ...
                <div class="col-lg-4 t-mb-50 mb-lg-0">
                    <ul class="t-list list-group service-list">
                        <li class="service-list__item">
                            <a href="#digitalMarketing" class="t-link active service-list__link t-link--primary w-100 text-capitalize font-weight-bold" data-toggle="list">
                                digital marketing
                            </a>
                        </li>
                        <li class="service-list__item">
                            <a href="#seo" class="t-link t-link--primary service-list__link w-100 text-capitalize font-weight-bold" data-toggle="list">
                                search engine optimization
                            </a>
                        </li>
                        <li class="service-list__item">
                            <a href="#socialMarketing" class="t-link t-link--primary service-list__link w-100 text-capitalize font-weight-bold" data-toggle="list">
                                social media marketing
                            </a>
                        </li>
                        <li class="service-list__item">
                            <a href="#brandingDesign" class="t-link t-link--primary service-list__link w-100 text-capitalize font-weight-bold" data-toggle="list">
                                branding design
                            </a>
                        </li>
                        <li class="service-list__item">
                            <a href="#webService" class="t-link t-link--primary service-list__link w-100 text-capitalize font-weight-bold" data-toggle="list">
                                web & host service
                            </a>
                        </li>
                    </ul>
