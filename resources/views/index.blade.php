            ...
            <div class="row t-mt-70" data-sal="slide-down" data-sal-duration="1300">
                <div class="col-md-4 t-mb-30 mb-md-0">
                    <div class="cards border">
                        <div class="cards__img mx-auto">
                            <img src="assets/img/showcase-icon-1.png" alt="zolfin" class="img-fluid w-100" />
                        </div>
                        ...
                        <div class="cards__footer text-center t-mt-30">
                            <a href="portfolio.html" class="t-link t-link--alpha">
                ...
                <div class="col-md-4 t-mb-30 mb-md-0">
                    <div class="cards border">
                        ...
                        <div class="cards__footer text-center t-mt-30">
                            <a href="portfolio.html" class="t-link t-link--alpha cards__footer-link">
                                <span class="cards__footer-icon">
                                    <i class="las la-plus-circle"></i>
                                </span>
                                <span class="text-capitalize font-weight-bold">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 t-mb-50 mb-lg-0" data-sal="slide-right" data-sal-duration="1300">
                    <img src="assets/img/about-img.png" alt="zolfin" class="img-fluid" />
                </div>
                <div class="col-lg-6 text-center text-md-left" data-sal="slide-left" data-sal-duration="1300">
                    ...
                    <div class="t-mt-30 d-flex align-items-center">
                        ...
                        <a href="#" class="bttn-video bttn-rounded bttn-primary-transparent text-capitalize">
                            <span class="xlg-text">
                                <i class="las la-play"></i>
                            </span>
                        </a>
                ...
                <div class="col-12">
                    <div class="service-slider">
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img mx-auto ml-lg-0">
                                    <img src="assets/img/showcase-icon-4.png" alt="zolfin" class="img-fluid w-100" />
                                </div>
                                <div class="cards__body text-center text-lg-left">
                                    <h3 class="text-capitalize cards__body-title">
                                        Grow Traffic
                                    </h3>
                                    <p class="mb-0 t-text-heading">
                                ...
                                <div class="cards__footer t-mt-30 text-center text-lg-left">
                                    <a href="service-details.html" class="t-link bttn bttn-md bttn-round bttn-primary text-capitalize">
                                        get started
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img mx-auto ml-lg-0">
                                    <img src="assets/img/showcase-icon-5.png" alt="zolfin" class="img-fluid w-100" />
                                </div>
                                <div class="cards__body text-center text-lg-left">
                                    <h3 class="text-capitalize cards__body-title">
                                        Marketing Plan
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img">
                                    <img src="assets/img/showcase-icon-6.png" alt="zolfin" class="img-fluid w-100" />
                                </div>
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img">
                                    <img src="assets/img/showcase-icon-7.png" alt="zolfin" class="img-fluid w-100" />
                                </div>
                                <div class="cards__body">
                                    <h3 class="text-capitalize cards__body-title">
                                        Grow Traffic
                        ...
                        <div class="project-slider">
                                ...
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/project-img-1.png" alt="zolfin" class="img-fluid w-100" />
                                        </a>
                                    </div>
                                    <div class="project-card__body">
                                        <a href="portfolio-details.html" class="t-link t-link--alpha project-card__link">
                                            <i class="las la-plus"></i>
                                        </a>
                                        <a href="portfolio.html" class="t-link text-uppercase font-weight-bold xsm-text t-link-alpha">
                                            web design
                                        </a>
                                        <h4 class="text-capitalize t-mt-10 mb-0">
                                            <a href="portfolio-details.html" class="t-link t-link--alpha">
                            ...
                            <div class="project-slider__item">
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/project-img-2.png" alt="zolfin" class="img-fluid w-100" />
                                        </a>
                                    </div>
                                    <div class="project-card__body">
                                        <a href="portfolio-details.html" class="t-link t-link--alpha project-card__link">
                                        ...
                                        <a href="portfolio.html" class="t-link text-uppercase font-weight-bold xsm-text t-link-primary">
                                            branding
                                        </a>
                                        <h4 class="text-capitalize t-mt-10 mb-0">
                                            <a href="portfolio-details.html" class="t-link t-link--alpha">
                            ...
                            <div class="project-slider__item">
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img src="assets/img/project-img-3.png" alt="zolfin" class="img-fluid w-100" />
                                        </a>
                                    </div>
                                    <div class="project-card__body">
                                        <a href="portfolio-details.html" class="t-link t-link--alpha project-card__link">
            ...
            <div class="row t-mt-85 justify-content-center">
                <div class="col-12 col-md-6 text-center">
                    <div class="list-group flex-row justify-content-center">
                        <a href="#monthly" class="t-mr-25 t-link bttn bttn-md bttn-round bttn-light text-capitalize active" data-toggle="list">
                            monthly
                        </a>
                        <a href="#yearly" class="t-link bttn bttn-md bttn-round bttn-light text-capitalize" data-toggle="list">
                            yearly
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 t-mb-30 mb-lg-0">
                                    <div class="price-card border">
                                        ...
                                        <div class="price-card__price t-bg-beta">
                                            <span class="price-card__price-title">
                                                $29
                                                <span class="price-card__price-title-sm">
                                                    per month
                                                </span>
                                            </span>
                                        </div>
                                        <div class="price-card__body t-pt-30">
                                            <ul class="t-list price-list price-list--column">
                                        ...
                                        <div class="price-card__footer t-pt-30 text-center">
                                            <a href="price.html" class="t-link bttn bttn-md bttn-round bttn-beta-transparent text-capitalize">
                                                start free trial
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4 t-mb-30 mb-lg-0">
                                    <div class="price-card border">
                                        <div class="price-card__img mx-auto">
                                            <img src="assets/img/price-img-2.png" alt="zolfin" class="img-fluid w-100" />
                                        </div>
                                        <div class="price-card__price t-bg-primary">
                                            <span class="price-card__price-title">
                                                $80
                                                <span class="price-card__price-title-sm">
                                                    per month
                                        ...
                                        <div class="price-card__footer t-pt-30 text-center">
                                            <a href="price.html" class="t-link bttn bttn-md bttn-round bttn-primary text-capitalize" tabindex="0">
                                                get started
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="price-card border">
                                        <div class="price-card__img mx-auto">
                                            <img src="assets/img/price-img-3.png" alt="zolfin" class="img-fluid w-100" />
                                        </div>
                                        <div class="price-card__price t-bg-gamma">
                                            <span class="price-card__price-title">
                                                $99
                                                <span class="price-card__price-title-sm">
                                                    per month
                                        ...
                                        <div class="price-card__footer t-pt-30 text-center">
                                            <a href="price.html" class="t-link bttn bttn-md bttn-round bttn-gamma-transparent text-capitalize">
                                                start free trial
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0" data-sal="slide-right" data-sal-duration="1300">
                    <div class="counter-card border d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0" data-sal="slide-down" data-sal-duration="1300">
                    <div class="counter-card border d-flex align-items-center">
                        <div class="counter-card__icon-box t-bg-beta t-mr-16">
                            <span class="counter-card__icon t-text-light">
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0" data-sal="slide-up" data-sal-duration="1300">
                    <div class="counter-card border d-flex align-items-center">
                        <div class="counter-card__icon-box t-bg-gamma t-mr-16">
                            <span class="counter-card__icon t-text-light">
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0" data-sal="slide-left" data-sal-duration="1300">
                    <div class="counter-card border d-flex align-items-center">
                        <div class="counter-card__icon-box t-bg-delta t-mr-16">
                            <span class="counter-card__icon t-text-light">
                        ...
                        <div class="testimonials-slider__item">
                            <div class="testimonials">
                                ...
                                <div class="testimonials__content t-mt-30 mt-md-0">
                                    <h6 class="mt-0 t-text-primary text-capitalize text-center text-md-left">
                                        Christ Deo
                                    </h6>
                                    <p class="xsm-text text-capitalize text-center text-md-left">
            ...
            <div class="row t-mt-85 zl-process">
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img src="assets/img/process-icon-1.png" alt="zolfin" class="img-fluid w-100" />
                            </a>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0 align-self-xl-end">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img src="assets/img/process-icon-2.png" alt="zolfin" class="img-fluid w-100" />
                            </a>
                        </div>
                        <div class="price-card__news-body">
                            <h5 class="t-mt-0 text-capitalize text-center">
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img src="assets/img/process-icon-3.png" alt="zolfin" class="img-fluid w-100" />
                            </a>
                        </div>
                        <div class="price-card__news-body">
                            <h5 class="t-mt-0 text-capitalize text-center">
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0 align-self-xl-end">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img src="assets/img/process-icon-4.png" alt="zolfin" class="img-fluid w-100" />
                            </a>
                        </div>
                        <div class="price-card__news-body">
                            <h5 class="t-mt-0 text-capitalize text-center">
            ...
            <div class="row t-mt-70 ">
                <div class="col-md-4 t-mb-30 mb-md-0">
                    <div class="price-card border t-bg-light">
                        ...
                        <div class="price-card__news-body text-center text-lg-left">
                            <h4 class="t-mt-0">
                                <a href="blog-details.html" class="t-link t-link--alpha">
                                    They're getting to know you by way of
                                </a>
                            </h4>
                            <a href="#" class="t-link t-link-alpha xsm-text">
                                <i class="las la-calendar-alt"></i>
                                28 June 2019
                            </a>
                        </div>

                        <div class="price-card__footer t-pt-30 text-center text-lg-left">
                            <a href="blog-details.html" class="t-link bttn bttn-md bttn-round bttn-primary text-capitalize">
                                read more
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 t-mb-30 mb-md-0">
                    <div class="price-card border t-bg-light">
                        ...
                        <div class="price-card__news-body text-center text-lg-left">
                            ...
                            <a href="#" class="t-link t-link-alpha xsm-text text-center text-lg-left">
                                <i class="las la-calendar-alt"></i>
                                28 June 2019
                            </a>
                        </div>
