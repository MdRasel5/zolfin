        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 t-mb-50 mb-lg-0">
                    <span class="text-uppercase t-text-alpha font-weight-bold">
                        OVERVIEW
                    </span>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5 col-md-4 t-mb-10">
                            <span class="lg-text text-capitalize font-weight-bold">
                                Categories :
                            </span>
                        </div>
                        ...
                        <div class="col-7 col-md-8 t-mb-10">
                            <ul class="t-list social-list justify-content-start">
                    ...
                    <button class="t-mt-50 newsletter__button bttn bttn-round bttn-alpha bttn-md text-uppercase border-0">
                        visit site
                        <i class="las la-long-arrow-alt-right"></i>
                    </button>
                </div>
                <div class="col-lg-7">
                    <img src="assets/img/portfolio-img.png" alt="zolfin" class="img-fluid" />
                </div>
            </div>
